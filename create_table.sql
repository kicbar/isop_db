...
CREATE TABLE USERS
(
  ID_USER INTEGER default USER_SEQ.NEXTVAL CONSTRAINT id_user_pk2 PRIMARY KEY 
...
(
  ID_USER_FIRM INTEGER DEFAULT USER_FIRM_SEQ.NEXTVAL CONSTRAINT id_user_firm_pk PRIMARY KEY NOT NULL
...
(
  ID_POSITION INTEGER DEFAULT POSITION_SEQ.NEXTVAL CONSTRAINT id_position_pkt PRIMARY KEY NOT NULL
, ID_FACTURE INTEGER NOT NULL
, FACTURE_NAME VARCHAR2(20) NOT NULL
, ID_PRODUCT INTEGER NOT NULL
, PRICE NUMBER(10,2) NOT NULL
...
, INSERT_DATE TIMESTAMP default sysdate
, STATUS NUMBER(1,0) DEFAULT 1
, CONSTRAINT id_value_type_p_fkt FOREIGN KEY (ID_VALUE_TYPE) REFERENCES VALUE_TYPES(ID_VALUE_TYPE)
, CONSTRAINT id_amount_type_p_fkt FOREIGN KEY (ID_AMOUNT_TYPE) REFERENCES AMOUNT_TYPES(ID_AMOUNT_TYPE)
, CONSTRAINT id_position_facture_fkt FOREIGN KEY (ID_FACTURE) REFERENCES FACTURES(ID_FACTURE)
, CONSTRAINT id_position_product_fkt FOREIGN KEY (ID_PRODUCT) REFERENCES PRODUCTS(ID_PRODUCT)
);
insert into positions_temp(ID_FACTURE, FACTURE_NAME, ID_PRODUCT, PRICE, AMOUNT, ID_AMOUNT_TYPE, ID_VALUE_TYPE) VALUES (2, 'FV/02/02/2020', 3, 10, 10, 1, 1);
insert into positions_temp(ID_FACTURE, FACTURE_NAME, ID_PRODUCT, PRICE, AMOUNT, ID_AMOUNT_TYPE, ID_VALUE_TYPE) VALUES (2, 'FV/02/02/2020', 2, 30, 5, 2, 1);
insert into positions_temp(ID_FACTURE, FACTURE_NAME, ID_PRODUCT, PRICE, AMOUNT, ID_AMOUNT_TYPE, ID_VALUE_TYPE) VALUES (2, 'FV/02/02/2020', 1, 20, 4, 3, 1);
insert into positions_temp(ID_FACTURE, FACTURE_NAME, ID_PRODUCT, PRICE, AMOUNT, ID_AMOUNT_TYPE, ID_VALUE_TYPE) VALUES (5, 'FV/02/02/2020', 8, 10, 3, 4, 1);
insert into positions_temp(ID_FACTURE, FACTURE_NAME, ID_PRODUCT, PRICE, AMOUNT, ID_AMOUNT_TYPE, ID_VALUE_TYPE) VALUES (3, 'FV/02/02/2020', 4, 15, 3, 4, 1);
